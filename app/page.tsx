      ...
      <section className="content-section" id="prospection">
        ...
        <div className="prospect-toolkit">
          ...
          <div className="prospect-tools-grid">
            ...
            <article><b>02 · EXTRAIRE LES FICHES</b><p>Outscraper ou Apify pour Google Maps, Instant Data Scraper pour une page autorisée, PhantomBuster pour des workflows ciblés.</p><em>But : nom, activité, adresse, téléphone pro, site et note.</em></article>
          ...
          <div className="scrape-recipe"><b>EXEMPLE DE WORKFLOW</b><span>“Restaurants Lyon” → extraction Google Maps → retirer chaînes et doublons → garder ceux sans site ou avec un site faible → vérifier manuellement 30 fiches → appeler 15 entreprises → noter chaque résultat.</span></div>
