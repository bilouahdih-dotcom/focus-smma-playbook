...
export const metadata: Metadata = {
  ...
  description: "Le guide SMMA premium de BS IA : 28 modules pour choisir un service, prospecter, vendre, livrer et structurer une agence depuis zéro.",
  ...
  openGraph: {
    siteName: "BS IA",
    title: "BS IA — SMMA Masterbook 2026",
    description: "28 modules, 15 services, boîtes à outils, scripts de vente, modèles copiables et système complet pour lancer une agence SMMA.",
    type: "website",
    locale: "fr_FR",
    url: "/",
